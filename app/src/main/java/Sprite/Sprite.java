...
import com.example.pequespiders.PequeSpidersRenderer;
...
public class Sprite
{
    ...
    public Sprite()
    {
        ...
        base = new RectF(-50f * PequeSpidersRenderer.ssu, 50f*PequeSpidersRenderer.ssu, 50f*PequeSpidersRenderer.ssu, -50f*PequeSpidersRenderer.ssu);

        // Initial translation
        translation = new PointF(50f*PequeSpidersRenderer.ssu,50f*PequeSpidersRenderer.ssu);
